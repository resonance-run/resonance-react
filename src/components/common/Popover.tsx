...
export const PopoverTrigger = React.forwardRef<HTMLElement, React.HTMLProps<HTMLElement> & PopoverTriggerProps>(
  function PopoverTrigger(componentProps, propRef) {
    const { children, asChild = false, ...props } = componentProps;
    const context = usePopoverContext();
    // @ts-expect-error: Any is okay in this case
    ...
    if (asChild && React.isValidElement(children)) {
      return React.cloneElement(
        ...
        context.getReferenceProps({
          ref,
          ...props,
          // @ts-expect-error We know this is a ReactNode with props
          ...children.props,
...
export const PopoverContent = React.forwardRef<HTMLDivElement, React.HTMLProps<HTMLDivElement>>(
  ...
  function PopoverContent(componentProps, propRef) {
    const { style, children, ...props } = componentProps;
...
export const PopoverHeading = React.forwardRef<HTMLHeadingElement, React.HTMLProps<HTMLHeadingElement>>(
  function PopoverHeading(componentProps, ref) {
